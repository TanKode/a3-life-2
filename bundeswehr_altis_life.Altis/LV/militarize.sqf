...
private ["_gerMenArray","_greenMenArray","_grpId","_customInit","_cPos","_skls","_skills","_dir","_range","_unitType","_unit","_radius","_men","_vehicles","_still","_centerPos","_menAmount","_vehAmount","_milHQ","_milGroup","_menArray","_blueMenArray","_redMenArray","_yellowMenArray","_side","_pos","_yellowCarArray","_allUnitsArray","_menRatio","_vehRatio","_diveArray","_validPos","_side","_driver","_whichOne","_vehicle","_crew","_thisArray","_smokesAndChems","_doorHandling","_BLUdivers","_OPFdivers","_INDdivers"];
...
_gerMenArray = ["BWA3_Rifleman_Tropen","BWA3_Grenadier_Tropen","BWA3_SL_Tropen","BWA3_TL_Tropen","BWA3_RiflemanAA_Fliegerfaust_Tropen","BWA3_RiflemanAT_Pzf3_Tropen","BWA3_RiflemanAT_RGW90_Tropen","BWA3_SniperG82_Tropen"];
...
{
    _x allowDamage true;
	_x addEventHandler ["killed", {_this execVM "unitKilled.sqf"}];
