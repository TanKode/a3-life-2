...
/*  Revert Keybinds      */ _RKB = true;	/* true or false */	/* recommended:  true  Removes custom Keybinds and sets back the default ones */
...
/*  HandleDamage check   */ _HDC = true;	/* true or false */	/* *experimental + Epoch only* - probably publicVariableServer spam but no more godmode hackers. */
...
_onLoadUnload1 = [
	...
	'RscDisplayMissionFail','RscDisplayLogin','RscDisplayModLauncher','RscDisplayDifficulty','RscDisplayConfigure','RscDisplaySelectIsland'
];
...
[
	'MixedScript.sqf','justtrolling.sqf','A3AH.sqf','hackfr.sqf',
...
[
	'arsenalOpened','BIS_fnc_arsenal_fullArsenal','n912','TBMKnlist','PLAY','ALTISLIFENEXT3',
